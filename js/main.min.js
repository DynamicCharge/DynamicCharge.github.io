...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    var titleSwiper = document.querySelector('.title__slider');
    if (titleSwiper) {
      var swiper = new Swiper(titleSwiper, {
        slidesPerView: 1,
        pagination: {
          el: titleSwiper.querySelector('.swiper-pagination')
        }
      });
    }
    if (window.innerWidth <= 768) {
      var compSwiper = document.querySelector('.competencies__items.swiper');
      var _swiper = new Swiper(compSwiper, {
        slidesPerView: 1.5,
        spaceBetween: 20
      });
    }
    $('.header__burger').on('click', function () {
      ...
      if ($this.hasClass('is-active')) {
        ...
        $list.fadeOut(300).removeClass('is-active');
      } else {
        $this.addClass('is-active');
        $list.fadeIn(300).addClass('is-active');
      }
    });
